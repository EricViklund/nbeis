        ...
        \begin{columns}[t]
            \begin{column}{0.32\linewidth}
                \begin{alertblock}{\label{sec:introduction}Key Findings}
                    \begin{itemize}
                        \item Electrochemical impedance spectroscopy (EIS) is used to analyze the Nb Electropolishing (EP) chemical reaction.
                        \item The impedance is measured at different polishing voltages.
                        \item The distribution of relaxation times (DRT) is calculated from the EIS data.
                        \item A second capacitive peak appears when the voltage is increased which corresponds to a reduction in surface etching.
                    \end{itemize}
                \end{alertblock}
